...
**Tests**: Per constitution (Principle VII), unit and integration tests are REQUIRED
for changed behavior. Include test tasks for every user story unless the feature is
docs-only.
...
- [ ] T009 Setup environment configuration management (Pydantic Settings)
- [ ] T010 [P] Register provider factories (LLM, embedding, vector DB, reranker)
